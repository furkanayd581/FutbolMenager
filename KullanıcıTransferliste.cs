...
namespace Futbolmenager2
{
    public partial class KullanıcıTransferliste : Form
    {
        ...
        public KullanıcıTransferliste(string ID, string sporcu_no,string sporcu_adi, string sporcu_soyadi, string sporcu_yas, string sporcu_mevki, string sporcu_ayak, string sporcu_kulup, string sporcu_satis_fiyati, string sporcu_satis_durumu, string sporcu_boy, string sporcu_uyruk)
        {
            InitializeComponent();
